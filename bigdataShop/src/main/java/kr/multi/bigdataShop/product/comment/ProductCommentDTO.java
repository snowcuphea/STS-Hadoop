...
public class ProductCommentDTO {
	...
	public String toString() {
		return "ProductCommentDTO [prd_no=" + prd_no + ", mem_id=" + mem_id + ", pro_comment=" + pro_comment + ", writedate="
				+ writedate + "]";
	}
	...
	public void setPro_comment(String comment) {
		this.pro_comment = comment;
	}
